...
<script type="text/javascript">
    ...
    var baseDir = '{$content_dir|escape:'quotes':'UTF-8'}';
    ...
    {if isset($isLogged)&&$isLogged|intval}
...
<a class="wishtlist_top nav_link"
   href="{$link->getModuleLink('blockwishlist', 'mywishlist', array(), true)|escape:'html':'UTF-8'}">
    <span>{l s='My Wishlist' mod='blockwishlist'}</span>
</a>
<input type="hidden" value="{l s='The product was successfully added to your wishlist.'  mod='blockwishlist'}" class="wl_login"/>
<input type="hidden" value="{l s='You must be logged in to manage your wishlist.' mod='blockwishlist'}" class="wl_not_login"/>
{literal}
    <script type="text/javascript">
