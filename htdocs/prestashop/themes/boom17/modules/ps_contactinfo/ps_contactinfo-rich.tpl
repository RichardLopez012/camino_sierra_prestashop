...
<div class="contact-rich">
 {if isset($tc_config.YBC_TC_CONTACT_FORM_LAYOUT) && $tc_config.YBC_TC_CONTACT_FORM_LAYOUT|escape:'html':'UTF-8' != 'contact_layout1'}
    {if isset($tc_config.YBC_TC_CONTACT_PAGE_TEXT|escape:'html':'UTF-8')}
        <div class="contact_descrip">
            <div class="container">
                <span class="des_title">{$tc_config.YBC_TC_CONTACT_PAGE_TEXT|escape:'html':'UTF-8'}</span>
            </div>
        </div>
    {/if}
 {/if}
  ...
  {if $contact_infos.email}
    <div class="block">
      ...
      <div class="data email">
        ...
        <a href="mailto:{$contact_infos.email|escape:'mail':'UTF-8'}">{$contact_infos.email|escape:'mail':'UTF-8'}</a>
       </div>
    </div>
  {/if}
</div>
