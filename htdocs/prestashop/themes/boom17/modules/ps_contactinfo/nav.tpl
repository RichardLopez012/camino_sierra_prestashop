...
<div id="_desktop_contact_link">
  <div id="contact-link">
    {if isset($tc_config.BLOCKCONTACTINFOS_PHONE_CALL) && $tc_config.BLOCKCONTACTINFOS_PHONE_CALL|escape:'html':'UTF-8'}
    ...
    {if isset($contact_infos.email) && $contact_infos.email}
     <div class="contact_link_item">
          <a href="mailto:{$contact_infos.email|escape:'mail':'UTF-8'}">
              ...
              {l s='Email: ' d='Modules.Contactinfo.Shop'}{$contact_infos.email|escape:'mail':'UTF-8'}
          </a>
      </div>
    {/if}
  </div>
