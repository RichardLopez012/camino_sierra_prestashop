...
{if $posts}
    {if $page == 'home'}
        ...
        {/if}
        <div class="homeblog_wrapper custom_blog_full_width col-sm-12 col-xs-12">
            <div class="block ybc_block_latest {$blog_config.YBC_BLOG_FREE_RTL_CLASS|escape:'html':'UTF-8'}
page_home {if isset($blog_config.YBC_BLOG_FREE_HOME_POST_TYPE) && $blog_config.YBC_BLOG_FREE_HOME_POST_TYPE=='default' || count($posts)<=1}ybc_block_default{else}ybc_block_slider{/if}">
                                ...
                                <div class="ybc-blog-latest-post-content">
                                    ...
                                    {if $post.short_description}
                                        <div class="blog_description">
                                            <p>{$post.short_description|strip_tags:'UTF-8'|truncate:100:'...'|escape:'html':'UTF-8'}</p>
                                        </div>
