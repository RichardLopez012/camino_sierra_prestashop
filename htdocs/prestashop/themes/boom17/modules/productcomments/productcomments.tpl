...
var productcomments_controller_url = '{$productcomments_controller_url|escape:'quotes':'UTF-8'}';
...
var productcomments_url_rewrite = '{$productcomments_url_rewriting_activated|escape:'quotes':'UTF-8'}';
			...
			<div class="row">
				{if isset($product_class) && $product_class}
					<div class="product clearfix  col-xs-12 col-sm-6">
						<img src="{$productcomment_cover_image|escape:'quotes':'UTF-8'}" alt="{$product_class->name|escape:'html':'UTF-8'}" />
				...
				<div class="new_comment_form_content col-xs-12 col-sm-6">
						...
						{foreach from=$criterions item='criterion'}
							<li>
								...
								<div class="star_content">
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_comment_criterion|round nofilter}]" value="1" />
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_comment_criterion|round nofilter}]" value="2" />
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_comment_criterion|round nofilter}]" value="3" />
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_comment_criterion|round nofilter}]" value="4" checked="checked" />
									<input class="star not_uniform" type="radio" name="criterion[{$criterion.id_product_comment_criterion|round nofilter}]" value="5" />
								</div>
					...
					<div id="new_comment_form_footer">
						<input id="id_product_comment_send" name="id_product" type="hidden" value='{$id_product_comment_form|intval}' />
