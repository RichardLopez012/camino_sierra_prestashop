...
$(document).ready(function () {
    ...
    $('.tabs-home-nav li:first-child a.nav-link').addClass('active');
    $('.tabs-home-content .featured-products:first-child').addClass('active');
    ...
    // show content searchbar
    var elementSlider = $('.search_block_top_fixed');
    var elementBody = $('body');
    $('.toogle_search_top').off().on('click', function (e) {
        e.stopPropagation();
        if( !elementSlider.hasClass('open')) elementSlider.addClass('open');
        else elementSlider.removeClass('open');
        
        if( !elementBody.hasClass('no_scroll')) elementBody.addClass('no_scroll');
        else elementBody.removeClass('no_scroll');
        e.preventDefault();
    });
    
    $('.search_block_top_close').off().on('click', function (e) {
        e.stopPropagation();
        if( !elementSlider.hasClass('open')) elementSlider.addClass('open');
        else elementSlider.removeClass('open');
    ...
    // action load more home tab
    if($('#bestseller_products').length > 0){
        $('#bestseller_products .view_more_products').off().on('click', function(){
            $(this).removeClass('active');
            $('#bestseller_products .view_less_products').addClass('active');
            $('#bestseller_products .loadmore').removeClass('poduct_hidden');
        });
        $('#bestseller_products .view_less_products').off().on('click', function(){
            $('#bestseller_products .view_less_products').removeClass('active');
            $('#bestseller_products .view_more_products').addClass('active');
            $('#bestseller_products .loadmore').addClass('poduct_hidden');
            $('html, body').animate({
                scrollTop: $(".tabs-home").offset().top
            }, 1000);
        });
    }
    // action load more home tab
    if($('#featured_products').length > 0){
        $('#featured_products .view_more_products').off().on('click', function(){
            $(this).removeClass('active');
            $('#featured_products .view_less_products').addClass('active');
            $('#featured_products .loadmore').removeClass('poduct_hidden');
        });
        $('#featured_products .view_less_products').off().on('click', function(){
            $('#featured_products .view_less_products').removeClass('active');
            $('#featured_products .view_more_products').addClass('active');
            $('#featured_products .loadmore').addClass('poduct_hidden');
            $('html, body').animate({
                scrollTop: $(".tabs-home").offset().top
            }, 1000);
        });
     ...
     // action load more home tab
    if($('#special_products').length > 0){
        $('#special_products .view_more_products').off().on('click', function(){
            $(this).removeClass('active');
            $('#special_products .view_less_products').addClass('active');
            $('#special_products .loadmore').removeClass('poduct_hidden');
        });
        $('#special_products .view_less_products').off().on('click', function(){
            $('#special_products .view_less_products').removeClass('active');
            $('#special_products .view_more_products').addClass('active');
            $('#special_products .loadmore').addClass('poduct_hidden');
            $('html, body').animate({
                scrollTop: $(".tabs-home").offset().top
            }, 1000);
        });
    ...
    if($('#new_products').length > 0){
        $('#new_products .view_more_products').off().on('click', function(){
            $(this).removeClass('active');
            $('#new_products .view_less_products').addClass('active');
            $('#new_products .loadmore').removeClass('poduct_hidden');
        });
        $('#new_products .view_less_products').off().on('click', function(){
            $('#new_products .view_less_products').removeClass('active');
            $('#new_products .view_more_products').addClass('active');
            $('#new_products .loadmore').addClass('poduct_hidden');
            $('html, body').animate({
                scrollTop: $(".tabs-home").offset().top
            }, 1000);
        });
    }
    // action click open menu home 2
   if($('.ybc-menu-toggle-h2').length > 0){
       $(document).on('click','.ybc-menu-toggle-h2',function(e){
            e.preventDefault();
            if($('.menu_and_cattree').stop().hasClass('active')){
                 $('.menu_and_cattree').stop().removeClass('active');
                 $('.menu_and_cattree.home2 .ets_mm_megamenu').stop().slideUp( "slow", function() {
                    // Animation complete.
                  });
            }
            else {
                $('.menu_and_cattree').stop().addClass('active');
                $('.menu_and_cattree.home2 .ets_mm_megamenu').stop().slideDown( "slow", function() {
                    // Animation complete.
                 });
            }
        });
        
        $('.close_menu2').off().on('click', function(e){
            e.preventDefault();
            if($('.menu_and_cattree').hasClass('active')){
                 $('.menu_and_cattree').removeClass('active');
                 $('.menu_and_cattree.home2 .ets_mm_megamenu').slideUp( 200, function() {
                    // Animation complete.
                  });
            }
            else {
                $('.menu_and_cattree').addClass('active');
                $('.menu_and_cattree.home2 .ets_mm_megamenu').slideDown( 200, function() {
                    // Animation complete.
                 });
            }
        });
