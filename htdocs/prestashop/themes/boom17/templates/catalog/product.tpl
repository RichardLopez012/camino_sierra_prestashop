...
{block name='head_seo' prepend}
  <link rel="canonical" href="{$product.canonical_url|escape:'quotes':'UTF-8'}">
{/block}
...
{block name='head' append}
  ...
  <meta property="og:image" content="{$product.cover.large.url|escape:'quotes':'UTF-8'}">
...
{block name='content'}
  ...
  <div id="main" itemscope itemtype="https://schema.org/Product">
    <meta itemprop="url" content="{$product.url|escape:'quotes':'UTF-8'}" />
