...
<div class="images-container images-container-vertical-right">
  ...
  {block name='product_cover'}
    <div class="product-cover{if (isset($tc_config.YBC_TC_JQZOOM) && $tc_config.YBC_TC_JQZOOM == 1)} product-cover-zoom{/if}">
      <img class="js-qv-product-cover" src="{$product.cover.bySize.large_default.url|escape:'quotes':'UTF-8'}" alt="{$product.cover.legend|escape:'html':'UTF-8'}" title="{$product.cover.legend|escape:'html':'UTF-8'}" style="width:100%;" itemprop="image">
        ...
        {foreach from=$product.images item=image}
          <li class="thumb-container">
            <img
              ...
              data-image-medium-src="{$image.bySize.medium_default.url|escape:'quotes':'UTF-8'}"
              data-image-large-src="{$image.bySize.large_default.url|escape:'quotes':'UTF-8'}"
              src="{$image.bySize.home_default.url|escape:'quotes':'UTF-8'}"
