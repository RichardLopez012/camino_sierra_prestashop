                ...
                <div class="logo_home3" id="logo_home3">
                    <a href="{$urls.base_url|escape:'html':'UTF-8'}">
                        <img class="logo img-responsive"
                             src="{if isset($tc_dev_mode) && $tc_dev_mode &&isset($logo_url)&&$logo_url}{$logo_url|escape:'quotes':'UTF-8'}{else}{$shop.logo|escape:'quotes':'UTF-8'}{/if}"
    ...
    ">
                        ...
                        <div class="nav">
                            <div class="left-nav">
                                {if isset($tc_config.YBC_SHOPMSG_WELCOME) && $tc_config.YBC_SHOPMSG_WELCOME}
                                    <span class="shop_msg_welcome">{$tc_config.YBC_SHOPMSG_WELCOME|escape:'html':'UTF-8'}</span>
                                {/if}
                            </div>
                            <div class="right-nav">
                                {hook h='displayNav2'}
        ...
        {block name='header_top'}
            <div class="header-top {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome4')}header-top4{/if}
                                    {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome5')}header-top5{/if}">
                <div class="container">
                    <div class="row">
                        <div class="header-top-content">
                            ...
                            {/if}
                            <div class="col-sm-4 col-xs-12  _desktop_logo
                                {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome4')} logo_home4{/if}"
                                 id="_desktop_logo">
                                <a href="{$urls.base_url|escape:'quotes':'UTF-8'}">
                                    <img class="logo img-responsive"
                                         src="{if isset($tc_dev_mode) && $tc_dev_mode &&isset($logo_url)&&$logo_url}{$logo_url|escape:'quotes':'UTF-8'}{else}{$shop.logo|escape:'quotes':'UTF-8'}{/if}"
                                         alt="{$shop.name|escape:'html':'UTF-8'}"/>
                                </a>
