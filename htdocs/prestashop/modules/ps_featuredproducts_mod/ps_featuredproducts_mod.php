...
class Ps_FeaturedProducts_Mod extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'ps_featuredproducts_mod';
        ...
        $this->templateFile = 'module:ps_featuredproducts_mod/views/templates/hook/ps_featuredproducts.tpl';
    }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('ps_featuredproducts_mod'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('ps_featuredproducts_mod'));
    }
    ...
    {
        return $this->display(__FILE__, 'tab.tpl', $this->getCacheId('Ps_Featured_Mod-tab'));
    }
    ...
    public function hookdisplayHomeTabContent($params)
    {
        ...
        $this->context->smarty->assign(
            array(
                'products' => $products,
                'allNewProductsLink' => Context::getContext()->link->getCategoryLink($this->getConfigFieldsValues()['HOME_FEATURED_CAT']),
            )
        );
        return $this->display(__FILE__, 'tabcontent.tpl', $this->getCacheId('Ps_Featured_Mod-home'));
    }
