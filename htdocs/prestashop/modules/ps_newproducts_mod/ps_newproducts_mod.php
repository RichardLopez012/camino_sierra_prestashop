...
class Ps_NewProducts_Mod extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'ps_newproducts_mod';
        ...
        $this->templateFile = 'module:ps_newproducts_mod/views/templates/hook/ps_newproducts.tpl';
    }
    ...
    {
        return $this->display(__FILE__, 'tab.tpl', $this->getCacheId('Ps_NewProducts_Mod-tab'));
    }
    ...
    public function hookdisplayHomeTabContent($params)
    {
        ...
        return $this->display(__FILE__, 'tabcontent.tpl', $this->getCacheId('Ps_NewProducts_mod-home'));
    }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('ps_newproducts_mod'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('ps_newproducts_mod'));
    }
