...
class Ps_BestSellers_Mod extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'ps_bestsellers_mod';
        ...
        $this->templateFile = 'module:ps_bestsellers_mod/views/templates/hook/ps_bestsellers.tpl';
    }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('ps_bestsellers_mod'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('ps_bestsellers_mod'));
    }
    ...
    {
        return $this->display(__FILE__, 'tab.tpl', $this->getCacheId('Ps_Bestsellers_Mod-tab'));
    }
    ...
    public function hookdisplayHomeTabContent($params)
    {
        ...
        return $this->display(__FILE__, 'tabcontent.tpl', $this->getCacheId('Ps_Bestsellers_Mod-home'));
    }
