...
class Ps_Specials_Mod extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'ps_specials_mod';
        ...
        $this->templateFile = 'module:ps_specials_mod/views/templates/hook/ps_specials.tpl';
    }
    ...
    {
        return $this->display(__FILE__, 'tab.tpl', $this->getCacheId('Ps_specials_mod-tab'));
    }
    ...
    public function hookdisplayHomeTabContent($params)
    {
        ...
        return $this->display(__FILE__, 'tabcontent.tpl', $this->getCacheId('Ps_specials-home'));
    }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('ps_specials_mod'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('ps_specials_mod'));
    }
