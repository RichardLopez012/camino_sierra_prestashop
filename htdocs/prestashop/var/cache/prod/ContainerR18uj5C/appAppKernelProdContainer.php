...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0gZ5jjTiKk', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'doofinder'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
        $e->addExcludePaths([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'doofinder'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity/index.php')]);
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'productcomments'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
        $f->addExcludePaths([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'productcomments'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity/index.php')]);
        $g = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'psxdesign'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
        $g->addExcludePaths([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'psxdesign'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity/index.php')]);
        $h = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_accounts'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
        $h->addExcludePaths([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_accounts'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity/index.php')]);
        $i = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_checkout'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
        $i->addExcludePaths([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_checkout'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity/index.php')]);
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9ZJZNMHvkN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DE-U9V7uCk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HU-ydSxYny', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5yf1yVII+p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XTvILQ9MQq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8FckxdvKmY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3+fmc1n6Qo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9hd-qrTSkA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YuEmNlJbvt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('tHmOC0Vmzj', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L-7tspr9p+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fooSOarBKE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Qg7EblD0c2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Bp5WfttmfI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1j0PXDzFfRz7eJWCDILRjkwQYSTOMBMORRwPN6HaK71XJf2wWw7NbYZaMB04W12B'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => '1j0PXDzFfRz7eJWCDILRjkwQYSTOMBMORRwPN6HaK71XJf2wWw7NbYZaMB04W12B',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-10-14',
            'locale' => 'es-ES',
            'use_debug_toolbar' => true,
            'cookie_key' => 'n6u6PY5kV9cXKRNh3zGFGxq6NSdsGNX9Ykb6qD3wLuoZkjh4ZJ6sQ2kff9n4nHwY',
            'cookie_iv' => 'DnEgZf2qDD3eoeiKJBwLtQWN7LsE8RjK',
            'new_cookie_key' => 'def000009f9717c71bca587a955e8adfc45825db4daa898228221c718046b2394a0875af508235823cc17d4f3c50fae658b697fbbd81a566139711c340f542ad7e905a99',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAqWYke6SgoxYLUNVTwSVj'."\n".'QjNmBFP2tW3JK1biNO9SfkdhKkDJ/CooZ5IrcQjJ0aTN8xpZdoBFU1RsyOvGgNZu'."\n".'Vc2CPtLd6eJBTqdEqYwxP/+enZ9shRj0LVR3YpVyITvK0EuNfDNKR4IWoUSl0tWh'."\n".'EDVxmUe4NQy3LDTQlfpMYW+UfJ2I0D9iLSi1MexQDanETpKcvMcbnS9mHZ08xGww'."\n".'lA8HukHlZElyzvqNS4jV5/gkECqifvf4kvTcM6THPEODE+cdxsviJlXxu+SPnRAW'."\n".'RvRDPYTeNNkkE8OQwRtznyNHpSsVxme9m1m9SkvfJ1J8DReiNZM9DNlfNu50qhCl'."\n".'dwIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvwIBADANBgkqhkiG9w0BAQEFAASCBKkwggSlAgEAAoIBAQCpZiR7pKCjFgtQ'."\n".'1VPBJWNCM2YEU/a1bckrVuI071J+R2EqQMn8KihnkitxCMnRpM3zGll2gEVTVGzI'."\n".'68aA1m5VzYI+0t3p4kFOp0SpjDE//56dn2yFGPQtVHdilXIhO8rQS418M0pHghah'."\n".'RKXS1aEQNXGZR7g1DLcsNNCV+kxhb5R8nYjQP2ItKLUx7FANqcROkpy8xxudL2Yd'."\n".'nTzEbDCUDwe6QeVkSXLO+o1LiNXn+CQQKqJ+9/iS9NwzpMc8Q4MT5x3Gy+ImVfG7'."\n".'5I+dEBZG9EM9hN402SQTw5DBG3OfI0elKxXGZ72bWb1KS98nUnwNF6I1kz0M2V82'."\n".'7nSqEKV3AgMBAAECggEANuNMwO9XyWAULI3ixHuLzOCAlrhqAOFgxHUzeHlvHlGc'."\n".'jydNCzLRwrVe9BIn6pDe1n1cLYRkchqx4OxcdlSEjbK4GAkVNHpGNOkH23P8ZUM7'."\n".'LtGARSQPwjxTLpND1rbcAV/pqSupTsA8+uYWYNktheX7N/JAIphLJby7NU1TwGHz'."\n".'JFK5z5PCcx67oFcNtuzFU9Pcuu4Ag+MSQ594tpuUDUyEHvB5thnsjqeIDsbXXR22'."\n".'xFHfQIxcNWoEWrS1edhar/KNofStTCrVFN7Th8BW/KdATTWwVIPOPXAMTL0tsKi4'."\n".'38Jo082DgK1zGQP2I30c9grcqqOxiYnLszINIUuVSQKBgQDQWiQTwwXrXxETk8dg'."\n".'rfbB3eg1tthIqnwGqWXiGNe1a+39nXFBQ5sdbSYfiFpEI50/sqZkdk1TrYv9r/KO'."\n".'Q78DUu1b3Wwt8tjqf/KUChJo92sYjK8IsKj8ulD70klY5rfh6SYYdbrzXhdqLTTX'."\n".'cogJhnOpcFx1SRsLH169vQ4uMwKBgQDQI4NH6XX1ZusmOmZ+GZccIqbZ85A+Iqy9'."\n".'kDyO4cdATY4ES9lAxVD0iGT9lObcdr2IOWPwRTbdiTGiJLvUIZ33TiS3bd90JtpD'."\n".'VbJx7cVbRcrC+7NTEplRQGqwQ/ONrBTql9ND6PTwW1BusPBRXD1X9B6IPNZJEeI3'."\n".'DN8ABs/frQKBgQDF5IgVuQubRn1qsdcSTcls079lnViKlFse3LCncl8Xsv6l/299'."\n".'xJ/E8FHga1sJEyadRKrkCrVhgBnSB9cDJvd7Sb2mnoXMkrdS69nUoEhiKHYxKBZr'."\n".'05d+C901gcMmzGTlDtSfMNszoi/tKijhZaguG+Upj05SG/CyvMX4w2N/nwKBgQCX'."\n".'ibOUUNqsEAGWtKBYoQMO3f/C4X0ccBx6a6BbmvB51b1XTW3gpYh6cS+uHJI041K8'."\n".'8qPblFkM1E1Jsxr5qHwdSUycLCerpnn02ljwb9/nwxmL+rul+P2dVZwXt3GErUwR'."\n".'PPb5E4v5z1HxNWvSoKic98SfBkQxsQ6VbA6UM2F3hQKBgQDHQYTSK//M0+nJWsT0'."\n".'9fyNhELNwQZXk7QA6eE/H9649j1aBHSyJQSKEFPAhER8Km3aUWnzf2r7Mv67UTWO'."\n".'TaNeM8dO2hec4RU82N7esheHbkrEgrD44uxx4vMbUIfmzufmFnRLaNtsHrKsUeqe'."\n".'IwMUWMQGoDGY45JIf2nQ1SN+8g=='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                68 => (\dirname(__DIR__, 4).'/modules/ets_blog/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/ph_recommendbycategories/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/doofinder/translations'),
                71 => (\dirname(__DIR__, 4).'/modules/ps_categorytree_mod/translations'),
            ],
            ...
            'kernel.secret' => '1j0PXDzFfRz7eJWCDILRjkwQYSTOMBMORRwPN6HaK71XJf2wWw7NbYZaMB04W12B',
