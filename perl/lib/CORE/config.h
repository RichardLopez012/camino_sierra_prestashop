 ...
 */
#define ARCHLIB "\\camino_sierra_prestashop\\perl\\lib"		/**/
/*#define ARCHLIB_EXP ""	/ **/
 ...
 */
#define BIN "\\camino_sierra_prestashop\\perl\\bin"	/**/
#define BIN_EXP "\\camino_sierra_prestashop\\perl\\bin"	/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB "\\camino_sierra_prestashop\\perl\\lib"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "\\camino_sierra_prestashop\\perl\\site\\lib"		/**/
/*#define SITEARCH_EXP ""	/ **/
 ...
 */
#define SITELIB "\\camino_sierra_prestashop\\perl\\site\\lib"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PERL_VENDORARCH "\\camino_sierra_prestashop\\perl\\vendor\\lib"		/**/
#define PERL_VENDORARCH_EXP "\\camino_sierra_prestashop\\perl\\vendor\\lib"		/**/
 ...
 *	be tacked onto this variable to generate a list of directories to search.
 */
#define PERL_VENDORLIB_EXP "\\camino_sierra_prestashop\\perl\\vendor\\lib"		/**/
