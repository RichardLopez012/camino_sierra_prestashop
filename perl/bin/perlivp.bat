...
#!perl
#line 29
    eval 'exec \Users\173587\Desktop\camino_sierra_prestashop\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = '\Users\173587\Desktop\camino_sierra_prestashop\perl\bin\perl.exe';
